/*
 * @Author: Mecil Meng
 * @Date: 2025-01-19 15:17:22
 * @LastEditors: Mecil Meng
 * @LastEditTime: 2025-01-19 16:48:30
 * @FilePath: /project_manager_system/client/src/app/(components)/Navbar/index.tsx
 * @Description:
 *
  ...
  return (
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3">
      ...
      <div className="flex items-center">
        ...
        <div className="bg-gary-200 ml-2 mr-5 hidden min-h-[2em] w-[0.1rem] md:inline-block"></div>
      </div>
    </div>
  );
};
