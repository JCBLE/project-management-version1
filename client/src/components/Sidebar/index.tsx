      ...
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <div className="z-50 flex min-h-[56px] items-center justify-between bg-white px-6 pt-3 dark:bg-black">
          ...
          {isSidebarCollapsed ? null : (
            ...
            >
              <X className="h-6 w-6 text-gray-800 hover:cursor-pointer dark:text-white" />
            </button>
          )}
        </div>
        {/* Team */}
...
const SidebarLink = ({ href, icon: Icon, label }: SidebarLinkProps) => {
  ...
  return (
    <Link href={href} className="w-full">
      <div
        className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-700 ${isActive ? "bg-gray-200 text-white dark:bg-gray-600" : ""} justify-start px-8 py-3`}
      >
        {isActive && (
