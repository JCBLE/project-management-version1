/*
 * @Author: Mecil Meng
 * @Date: 2025-01-20 17:46:03
 * @LastEditors: Mecil Meng
 * @LastEditTime: 2025-01-21 14:41:12
 * @FilePath: /project_manager_system/client/src/app/projects/BoardView/index.tsx
 * @Description:
 *
          ...
          <div className="flex flex-1 flex-wrap items-center gap-2">
            ...
            <div className="flex gap-2">
              {taskTagsSplit.map((tag) => (
                <div
                  key={tag}
                  className="rounded-full bg-blue-200 px-2 py-1 text-xs"
                >
                  {" "}
                  {tag}
                </div>
